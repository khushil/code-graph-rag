...
class CKernelAnalyzer:
    ...
    def _analyze_lock_operation(self, node: Node, context: Optional[str]) -> None:
    ...
    def _analyze_macro_call(self, node: Node, context: Optional[str]) -> None:
    ...
    def _extract_variable_name(self, declarator: Node) -> Optional[str]:
    ...
    def _get_identifier_text(self, node: Node) -> Optional[str]:
