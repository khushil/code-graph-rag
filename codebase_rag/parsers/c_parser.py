...
class CParser:
    ...
    def _get_type_name(self, node: Node) -> Optional[str]:
    ...
    def _get_identifier_text(self, node: Node, content: str) -> Optional[str]:
        ...
        if node.type in ["declarator", "init_declarator"]:
            ...
            def find_identifier(cursor) -> Optional[str]:
    ...
    def _get_macro_parameters(self, macro_node: Node, content: str) -> Optional[List[str]]:
    ...
    def _find_declarator(self, declaration_node: Node) -> Optional[Node]:
