...
class GitAnalyzer:
    ...
    def get_file_history(self, file_path: str, max_commits: int = 100) -> FileHistory | None:
    ...
    def _get_file_history_gitpython(self, file_path: str, max_commits: int) -> FileHistory | None:
    ...
    def _get_file_history_subprocess(self, file_path: str, max_commits: int) -> FileHistory | None:
